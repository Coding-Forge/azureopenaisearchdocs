...
class AzureSearchClient(object):
    ...
    def __init__(self, service_endpoint, azure_credential):
        self._service_endpoint = service_endpoint # os.getenv("SEARCH_ENDPOINT")
        #key = os.getenv("SEARCH_API_KEY")
        self._credential = azure_credential #AzureKeyCredential(key)
